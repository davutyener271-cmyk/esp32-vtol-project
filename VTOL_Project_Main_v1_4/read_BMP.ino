...
// Son gecerli basinci bulundugumuz konumda sifir metre kabul eder.
// ARM aninda bir kez cagrilir ve programi bekletmez.
bool reset_BMP_Altitude_Reference() {

  if (!bmpReady ||
      !bmpAltitudeReady ||
      !lastBMPReadingSuccessful ||
      bmpPressure < 30000.0f ||
      bmpPressure > 110000.0f) {

    return false;
  }

  bmpReferencePressure = bmpPressure;
  bmpAltitude = 0;
  Filtered_Altitude = 0;
